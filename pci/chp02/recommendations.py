...
# vim:fenc=utf-8
#
# Copyright © 2018 Rui Zhang <zryaq1983@gmail.com>
#
# Distributed under terms of the Free license.
...
def sim_tanimoto(prefs,p1,p2):
    intersection = [common_item for common_item in prefs[p1] if common_item in prefs[p2].keys()]
    return (float(len(intersection)) / (len(prefs[p1]) + len(prefs[p2]) - len(intersection)))
